...
object_key = 'esm_model.onnx'
local_model_path = 'esm_model.onnx'
...
def generate_tags(embedding):
    ...
    :param embedding: 1x1280 tensor ESM2 embedding of the input string.
    :return: A list of tags generated by the model.
    """
    # Convert embedding to numpy
    input_data = np.array(embedding, dtype=np.float32)
    
     # Check if input_data is already 1-dimensional
    ...
    query = [
        {
            "$vectorSearch": {
                ...
                "numCandidates": number_value*200,
